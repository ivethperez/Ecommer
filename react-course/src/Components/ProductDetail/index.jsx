...
hover:scale-105 duration-500 transform transition'>
            <figure className='relative mb-2 w-full h-3/5'>
                <div>
                    <XMarkIcon className='absolute top-0 right-0 flex justify-center items-center bg-[#2f323a9d] w-6 h-6 rounded-full m-2 p-1 font-bold cursor-pointer'
                        onClick={onCancel}></XMarkIcon>
                </div>
