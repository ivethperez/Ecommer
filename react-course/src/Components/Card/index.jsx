                ...
                <div className="">
                  <div className="mx-auto mt-3">
                    <div className="flex flex-wrap gap-3">
                      <label className="cursor-pointer" onClick={() => showPrice('kilo')}>
                        <input type="radio" className="peer sr-only" name="pricing" />
                        <div className=" rounded-md bg-white border text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                      ...
                      <label className="cursor-pointer" onClick={() => showPrice('medioKilo')}>
                        <input type="radio" className="peer sr-only" name="pricing" />
                        <div className="rounded-md bg-white text-gray-600  border ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center justify-between">
                      ...
                      <label className="cursor-pointer" onClick={() => showPrice('cuarto')}>
                        <input type="radio" className="peer sr-only" name="pricing" />
                        <div className="rounded-md bg-white text-gray-600 ring-2 border ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center justify-between">
