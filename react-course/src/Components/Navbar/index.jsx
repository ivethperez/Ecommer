...
export default function Example() {
  ...
  const [username, setUsername] = useState("");
    ...
    const renderView = () => {
        ...
        if (isUserSignOut) {
            return (
              <header className="w-full text-white bg-orange-300 p-1">
        ...
        <div className="ml-auto">
          {isLoggedIn ? (
            ...
            <Menu as="div" className="relative inline-block text-left">
              <div>
              <NavLink to="/sign-in">
                <button className="inline-flex justify-center items-center px-4 py-2 border border-white text-white text-sm font-medium hover:bg-orange-400 hover:text-gray-800">
                   Iniciar sesión
                </button>
                </NavLink>
              </div>
