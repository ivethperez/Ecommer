...
const Footerr = () => {
  const { setSearchByCategory,scrollTo,phoneNumber,signOut} = useShopiContext();
  const ocultar= () =>{
    setSearchByCategory()
}
const irWatsapp=() =>{
  window.open(`https://wa.me/${phoneNumber}?text=` + encodeURIComponent('Hola quiero pedir más información de sus productos.'), '_blank');
}
  return (
    <div>
{signOut ? (
          ...
          <div>
            <div className="flex items-center text-gray-900">
              ...
              <div className="ml-4"><p className="text-base font-semibold">Leier</p>
                <p className="mt-1 text-sm">Siguenos en nuestras redes sociales.</p>
              </div>
            </div>
            <div className="mt-6 flex gap-6">
              <a itemProp='url' className="group -m-1 p-1" aria-label="Follow on Facebook" href="https://www.facebook.com/profile.php?id=61580127320898" target="_blank"
  rel="noopener noreferrer">
               ...
               <a className="group -m-1 p-1" aria-label="Follow on Instagram" href="https://www.instagram.com/snacks_leier/" target="_blank"
  rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-zinc-900 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
              ...
              <a className="group -m-1 p-1" aria-label="Follow on TikTok" href="https://www.tiktok.com/@snacks_leier" target="_blank"
  rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-zinc-900 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
              ...
              <button className="group -m-1 p-1" aria-label="Follow on Whatsapp" onClick={()=>irWatsapp()} >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
